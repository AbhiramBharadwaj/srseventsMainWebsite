...
import { cn } from '../utils/cn.ts'; // Make sure to have this utility or use a relevant one for classnames
...
export const StickyScroll = ({ content, contentClassName }) => {
  ...
  const linearGradients = [
    ...
    'linear-gradient(to bottom right, var(--pink-300), var(--indigo-500))',
